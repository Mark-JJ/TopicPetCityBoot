...
<body>
<h1></h1>
<form action="/MemberEmailUpdateAction.controller" method="POST" enctype="multipart/form-data">
	...
	<div class="login-html">
		...
		<div class="login-form">
			<div class="sign-in-htm">
				<div class="group">
					<label for="pass" class="label" >欲修改的Email </label>
					<input id="pass" type="text" class="input"  name="emailAddress" >
	</div>
	<div class="group">
