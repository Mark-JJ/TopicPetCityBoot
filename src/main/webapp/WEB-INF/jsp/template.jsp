...
<body>
			...
			<div
				...
				<div class="flex-fill">
					<ul
						...
						<li class="nav-item"><a class="nav-link" href="index">首頁</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="product">商城</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="shop.html">論壇</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="contact.html">關於</a>
						</li>
					</ul>
				</div>
	...
	<div class="container py-5">
		<div class="row">
			...
			<div class="col-lg-3">
				<h1 class="h2 pb-4">商品中心</h1>
				<ul class="list-unstyled templatemo-accordion">
					<li class="pb-3"><a
						class="collapsed d-flex justify-content-between h3 text-decoration-none"
						href="#"> 會員資料 <i class="fa fa-fw fa-chevron-circle-down mt-1"></i>
					</a>
						<ul class="collapse show list-unstyled pl-3">
							<li><a class="text-decoration-none" href="#">飼料</a></li>
							<li><a class="text-decoration-none" href="#">用品</a></li>
						</ul></li>
					<li class="pb-3"><a
						class="collapsed d-flex justify-content-between h3 text-decoration-none"
						href="#"> 訂單管理 <i
						...
						<ul id="collapseTwo" class="collapse list-unstyled pl-3">
							<li><a class="text-decoration-none" href="#">飼料</a></li>
							<li><a class="text-decoration-none" href="#">罐頭</a></li>
							<li><a class="text-decoration-none" href="#">用品</a></li>
						</ul></li>
					<li class="pb-3"><a
						class="collapsed d-flex justify-content-between h3 text-decoration-none"
						...
						<ul id="collapseThree" class="collapse list-unstyled pl-3">
							<li><a class="text-decoration-none" href="#">兔子用</a></li>
							<li><a class="text-decoration-none" href="#">老鼠用</a></li>
							<li><a class="text-decoration-none" href="#">爬蟲用</a></li>
						</ul></li>
				</ul>
			</div>
