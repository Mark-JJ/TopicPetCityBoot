...
<body background="https://drimg01.scbao.com/160906/330613-160Z609251769.jpg" onload="javascript:document.insertMemberFormA.mId.focus();">
	<p />
<form action="MemberUpdateSuccess.controller" method="POST" enctype="multipart/form-data">
		<table border="1">
			<thead>
				<tr bgcolor='#C4E1FF'>
					<th height="60" colspan="2" align="center">更新會員資料</th>
				</tr>
			</thead>
			<tbody>
				<tr bgcolor='#C4E1FF'>
					<td width="120" height="40">ID:</td>
					<td width="600" height="40" align="left"><input id="upid" 
						style="text-align: left" name="upid" value="${updateID.id}"
						readonly unselectable="on" size="20">
				...
				<tr bgcolor='#C4E1FF'>
					...
					<td width="600" height="40" align="left"><input id="Q1"
						style="text-align: left" name="mail" value="${updateID.mail}"
						type="text" size="20">
						<div style="color: #FF0000; font-size: 60%; display: inline">${ErrorMsg.id}</div>
					</td>
				</tr>
				<tr bgcolor='#C4E1FF'>
					...
					<td width="600" height="40" align="left"><input id="Q2"
						style="text-align: left" name="password" value="${updateID.password}"
						type="text" size="20">
				...
				<tr bgcolor='#C4E1FF'>
					...
					<td width="600" height="40" align="left"><input name="phone"
						value="${updateID.phone}" type="text" size="20" id="Q3">
				...
				<tr bgcolor='#C4E1FF'>
					...
					<td width="600" height="40" align="left"><input
						name="name" value="${updateID.name}" type="text" size="20"
						id="Q4">
				...
				<tr bgcolor='#C4E1FF'>
					...
					<td width="600" height="40" align="left"><input name="numberID"
						value="${updateID.numberID}" type="text" size="20" id="Q5">
						<font color='blue' size="-1">&nbsp;&nbsp;(選填)認養寵物使用</font></td>
				</tr>
				<tr bgcolor='#C4E1FF'>
					<td width="120" height="40">生日:</td>
					<td width="600" height="40" align="left"><input
						name="birthday" value="${updateID.birthday}" type="text" size="20"
				...
				<tr bgcolor='#C4E1FF'>
					...
					<td width="600" height="40" align="left"><input name="address"
						value="${updateID.address}" type="text" size="20" id="Q7">
				...
				<tr bgcolor='#C4E1FF'>
					...
					<td width="600" height="40" align="left"><input name="gender"
						value="${updateID.gender}" type="text" size="20" id="Q8">
